...
export default function Login() {
  ...
  return (
    <section className="mx-auto flex flex-col items-center justify-center h-screen bg-emerald-700 w-full">
      <div className="flex flex-col gap-y-10 max-w-lg text-center bg-neutral-900 text-white p-4 rounded-lg w-full">
        ...
        <p className="text-sm text-muted-foreground">
          Ingresa sesión con tu cuenta de Google para acceder a esta página.
        </p>
